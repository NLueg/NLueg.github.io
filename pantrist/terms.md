...
Pantrist is provided to the user free of charge. Individual functions must be subscribed to for a fee. In order to use all functions, registration as a user with a user account may be required, stating user name and valid e-mail address, as well as an Internet connection.
